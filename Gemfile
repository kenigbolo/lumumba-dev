...
gem 'carrierwave', '>= 1.0.0.beta', '< 2.0' # Add carriewave gem to upload pictures to user profile
gem 'cloudinary', '~> 1.2'
...
gem 'puma', '~> 3' # Use Puma as the app server
...
gem 'will_paginate', '~> 3.1' # Gem for Rails 3+, Sinatra, and Merb Pagination
